...
/**
 * This class stands for GetShipmentsByPackageNumber StructType
 * @subpackage Structs
 */
class GetShipmentsByPackageNumber extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for GetShipmentsByPackageNumber
     * @uses GetShipmentsByPackageNumber::setUserName()
     * @uses GetShipmentsByPackageNumber::setPassword()
     * @uses GetShipmentsByPackageNumber::setInstallationValue()
     * @uses GetShipmentsByPackageNumber::setActors()
     * @uses GetShipmentsByPackageNumber::setPackageNumber()
     * @uses GetShipmentsByPackageNumber::setStartDateTime()
     * @uses GetShipmentsByPackageNumber::setEndDateTime()
     * @uses GetShipmentsByPackageNumber::setRequestConfig()
     ...
     */
    public function __construct($userName = null, $password = null, $installationValue = null, \ArrayType\ArrayOfint $actors = null, $packageNumber = null, $startDateTime = null, $endDateTime = null, $requestConfig = null)
    {
        $this
     ...
     * @param string $userName
     * @return \StructType\GetShipmentsByPackageNumber
     */
